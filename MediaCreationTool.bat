...
set VERSIONS=1507,1511,1607,1703,1709,1803,1809,1903,1909,20H1,20H2,21H1,21H2
set /a dV=14
...
if "%MCT%%PRE%"=="" call :choices2 MCT "%VERSIONS%" %dV% "Seleziona una versione" PRE "%PRESETS%" %dP% "MCT Preset" 11 white 0x005a9e 320
...
@echo off& title Multi-Windows by Fabrizio Amorelli - Universal MCT Wrapper by AveYo& set __COMPAT_LAYER=Installer& chcp 437 >nul& set set=& for %%s in (%*) do if /i %%s equ set set set=1 
if not defined set set /a BackClr=0x9 & set /a TextClr=0xf & set /a Columns=32 & set /a Lines=120 & set /a Buff=9999
...
echo https://github.com/AveYo/MediaCreationTool.bat
